...
import com.graduationproject.egyptnews.models.eeNews.Metatag;
...
public class HeadNewsRecycViewAdapter extends RecyclerView.Adapter<HeadNewsRecycViewAdapter.HeadNewsViewHolder> {
    ...
    private List<NewsRoom> articlesList;
    ...
    public HeadNewsRecycViewAdapter(List<NewsRoom> teamsList, Context context, HeadNewsRecycViewAdapter.onItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(@NonNull HeadNewsViewHolder holder, int position) {
        ...
        NewsRoom articles = articlesList.get(position);

        holder.tvNewsTitle.setText(articles.getNewsTitle());
        holder.tvPublishWebsite.setText(articles.getNewsContent());
    ...
    public void filterlist(ArrayList<NewsRoom> filteredList) {
